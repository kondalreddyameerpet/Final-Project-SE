...
game_sound = pygame.mixer.Sound("audio/spooky.mp3")
game_sound.set_volume(0.01)
celebration_sound = pygame.mixer.Sound("audio/auld.mp3")
collision_sound_loader = pygame.mixer.Sound("audio/hitWall.mp3")
game_sound.play()
...
def menu():
    ...
    menuPicture = pygame.image.load(os.path.join('mesh', "menuImage.jpg"))
    click = False
    while True:
        screen.fill((0, 0, 0))
...
def map300_manuelStimulation():
    ...
    # forrest image
    forrestImage = pygame.image.load(os.path.join('mesh', "300map.jpg"))

    # person one image
    person_One_Image = pygame.image.load(os.path.join('mesh', "tom.png"))
    person_One_Image.convert_alpha()
    person_One_Image.set_colorkey(alpha)

    # person two image
    person_Two_Image = pygame.image.load(os.path.join('mesh', "jerry.png"))
    person_Two_Image.convert_alpha()
    person_Two_Image.set_colorkey(alpha)

    # init position and draw player
    gameOverImage = pygame.image.load(os.path.join('mesh', "300gameover.jpg"))
...
def map500_manuelStimulation():
    ...
    # forrest image
    forrestImage = pygame.image.load(os.path.join('mesh', "500map.jpg"))
    ...
    # game over image
    gameOverImage = pygame.image.load(os.path.join('mesh', "500gameover.jpg"))
...
def vanGogh_Map_manuelStimulation():
    ...
    # forrest image
    forrestImage = pygame.image.load(os.path.join('mesh', "vanmap.jpg"))
    ...
    # game over image
    gameOverImage = pygame.image.load(os.path.join('mesh', "forrestgameover.jpg"))
...
def Map2560_manuelStimulation():
    ...
    # forrest image
    forrestImage = pygame.image.load(os.path.join('mesh', "2560map.jpg"))
    ...
    # game over image
    gameOverImage = pygame.image.load(os.path.join('mesh', "2560gameover.jpg"))
...
def k_3To5_game():
    ...
    # forrest image
    forrestImage = pygame.image.load(os.path.join('mesh', "forrest.jpg"))
...
def map300_manuelStimulation_3players():
    ...
    # person three image
    person_Three_Image = pygame.image.load(os.path.join('mesh', "sandy.png"))
...
def map300_manuelStimulation_4players():
    ...
    # person four image
    person_Four_Image = pygame.image.load(os.path.join('mesh', "squid.jpg"))
